    ...
    <div className="sidebar">
      <div className="ctx">
        ...
        <div className="box">
          ...
          <div>
            <a href="https://nyaa.si/user/ohys?f=0&c=0_0&q=" className="item">
              Nyaa.si
            </a>
          </div>
          <div>
            <a href="https://ohys.nl/tt/rss.php?dir=disk" className="item">
              RSS
            </a>
          </div>
        </div>
      ...
      <div className="ctx">
        ...
        <div className="box">
          <a
            ...
            href="https://discord.gg/EUvzwzx"
            title="Ohys-Raws Discord"
            className="item"
          >
